...
from gflownet.gflownet.envs.building_block import BuildingBlock
from gflownet.gflownet.utils.common import (
    concat_items,
    copy,
    extend,
    set_device,
...
class Batch:
    def __init__(
        ...
        self.envs: OrderedDict[int, BuildingBlock] = OrderedDict()
        ...
        self.masks_forward_available_1 = False#todo:need follow
    ...
    def get_terminating_states(
        ...
        if policy_1 is True:
            ...
            return self.env.statebatch2smiles(states_term)
        else:
            return states_term
